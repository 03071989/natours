...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1Ijoicm9nYmlya2luIiwiYSI6ImNrOTg4enhiNTAwZTczZnAyaGtlbXV2MTMifQ.IOpg66R9lwZlEdGxREOcWQ';
  var map = new mapboxgl.Map({
    container: 'map',
    style: 'mapbox://styles/rogbirkin/ck989cgwl4prm1invvnt1ez8z',
    ...
    return regeneratorRuntime.wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 3:
            res = _context2.sent;
            if (res.data.status === 'success') location.reload(true); //Makes the page load from the server, rather than cached data
...
var stripe = Stripe('pk_test_SP5SKwMzEBjoVZrnPbTpItRx00RJbuiNLM');
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            console.log(session); // 2) Create the checkout form + charge the credit card
